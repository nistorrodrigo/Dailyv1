export default async function handler(req, res) {
  ...
  const VARS = {
    reservas:    { id: 1,   label: "International Reserves",        unit: "US$ bn",  type: "stock", div: 1000    },
    ...
    depUSD:      { id: 108, label: "USD Deposits – Private Sector", unit: "US$ bn",  type: "stock", div: 1000    },
    prestARS:    { id: 26,  label: "Private Sector Loans (ARS$)",   unit: "ARS$ bn", type: "stock", div: 1000    },
    prestUSD:    { id: 125, label: "Private Sector Loans (USD)",    unit: "US$ bn",  type: "stock", div: 1000    },
