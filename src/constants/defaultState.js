...
export const DEFAULT_STATE = {
  ...
  fiIdeas: [
    { idea: "Long ARGENT 35/38", reason: "Attractive yield on long-duration sovereign" },
    { idea: "Long end of BONCAP curve (Apr/May/Jun 2027)", reason: "" },
    { idea: "RV: Sell BONTE 30 / Buy long-end BONCAP curve", reason: "" },
    { idea: "Long BONCER 2028", reason: "" },
  ],
  showEquity: true,
  showFI: true,
